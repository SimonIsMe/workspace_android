...
public class Blutooth extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		BluetoothService.checkBluetoothState(null);
	}
	...
	private void createLayoutReferences() {
		...
		this.image[0] = (ImageView) findViewById(R.id.image_0);
		this.image[1]= (ImageView) findViewById(R.id.image_1);
		this.image[2] = (ImageView) findViewById(R.id.image_2);
		this.image[3] = (ImageView) findViewById(R.id.image_3);
		
		for (int i = 0; i < Blutooth.MAX_DEVICES; i++) {
			this.image[i].setVisibility(View.GONE);
		}
	}
...
class SampleReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		BluetoothService.checkBluetoothState(intent);
	}
}